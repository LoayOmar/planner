              ...
              IconButton(
                onPressed: () async {
                  if (taskController.text.isNotEmpty) {
                    if(getSeconds(PlannerCubit.get(context).currentTaskDate, PlannerCubit.get(context).currentTaskTime) > 0) {
                      int len = PlannerCubit.get(context).tasks.length;
                      PlannerCubit.get(context).insertTaskToDatabase(
                        taskModel: TaskModel(
                      ...
                      await NotificationService().showNotification(
                        ...
                        getSeconds(PlannerCubit.get(context).currentTaskDate, PlannerCubit.get(context).currentTaskTime),
                        'task',
                      );
                      taskController.clear();
