            ...
            IconButton(
              onPressed: () {
                if(descriptionController.text.isNotEmpty) {
                  PlannerCubit.get(context).insertNoteToDatabase(
                    noteModel: NoteModel(
                      uId: PlannerCubit.get(context).userModel!.uId,
                      description: descriptionController.text,
                      imageUrl: PlannerCubit.get(context).noteImageUrl,
                  ...
                  showToast(text: 'Please add description', state: ToastStates.ERROR);
                }
              },
              icon: Icon(
                Icons.save,
              ...
              children: [
                    ...
                    InkWell(
                      ...
                      child: Card(
                        ...
                        child: Container(
                          ...
                          child: PlannerCubit.get(context).noteImage == null && PlannerCubit.get(context).noteImageUrl == null
                              ? Center(
                                  child: Icon(
                                    Icons.add,
                                    size: 100,
                ...
                InkWell(
                  onTap: () {
                    showDatePicker(
                      context: context,
                      initialDate: PlannerCubit.get(context).initialNewNoteDate,
